...
- support JDK6 & 7.
- fully packageable in jar files.
...
//...
    val appDependencies = Seq(
      "japid42" % "japid42_2.10" % "0.9.9" // use 0.9.5 if you want to use Japid routing with Play 2.1.1 or earlier
    )
...
# set the japid root to null explicitly in your global settings file, so the Japid engine will pick up the Japid scripts in the jars. 
...
## set the japid root to null explicitly in your global settings file:
<pre><code>
    public class Global extends GlobalSettingsWithJapid {
        @Override
        public void onStartJapid() {
