...
//...
    val appDependencies = Seq(
      ...
      "japid42" % "japid42_2.10" % "0.9.10.1" // use 0.9.9.1 if you want to use Japid routing with Play 2.1.1 or earlier
    )
...
# API upgrade: initial support for Play 2.2.0. internal API change to comply with the API changes in play 2.2.0, mainly the Result clas hierarchy.  
